...
关于 roomToken 的计算方法及 RTC Server API 的说明请查阅  [七牛连麦服务端 API 接口规范 v2.0](docs/Qiniu-RTC-Server-API-v2.md)，另外，我们也开源了一份 [App Server 的实现代码供开发者参考](https://github.com/pili-engineering/pili-sdk-demo-server)。
...
房间的 API 主要分为两个部分，一部分在客户端，另一部分在服务端。在客户端 SDK 中，只有加入/离开连麦房间的接口。我们把创建/销毁连麦房间的功能放到了服务端，由 App Server 向七牛的服务器发送请求来完成。关于服务端 API 的详细内容，请查阅  [七牛连麦服务端 API 接口规范 v2.0](docs/Qiniu-RTC-Server-API-v2.md)。
...
可参考 [这个文档](docs/how-to-upgrade-to-v2.md)
